package com.coccoc.news.base.prefs;
...
public class BasePrefs {
    ...
    private static SharedPreferences sharedPreferences = NewsApp.getInstance().getSharedPreferences("news-prefs", Context.MODE_PRIVATE);;
